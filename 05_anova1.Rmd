...
Для зависимых тестов (например, для попарных сравнений) эта вероятность чуть ниже (Winer et al. 1991), но все равно хорошо бы внести поправку в $\alpha_{per\ comparison}$.
