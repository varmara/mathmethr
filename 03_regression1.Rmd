...
- Доля стерильной пыльцы у межвидовых гибридов значимо возрастает с увеличением генетического расстояния ($b _1 = `r  round(coef(hybrid_lm[1])[1], 2)`$, $t = `r round(summary(hybrid_lm)$coefficients[2, 3], 2)`$, $p < 0.01$)
