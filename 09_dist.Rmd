...
\includegraphics[width=0.5\textwidth,keepaspectratio]{images/qual.png}

## Примеры коэффициентов для качественных данных

\includegraphics[width=0.5\textwidth,keepaspectratio]{images/qual_head.png}
...
\textbf{Особенности:} UPGMA и WUPGMС иногда могут приводить к инверсиям на дендрограммах

\includegraphics[width=0.5\linewidth]{images/clust-revert.png}
